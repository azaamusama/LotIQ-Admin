...
export const mockViolations: Violation[] = [
  {
    ...
    duration: '4h 45m',
    cameraId: 'CAM-01',
    aiReasoning: 'Vehicle not found in authorized list and has exceeded the maximum allowed visitor duration.'
  },
  {
    id: 'viol-2',
    vehicleId: 'v3',
    plate: 'LMN-5544',
    vehicleImage: 'https://picsum.photos/seed/ev/400/300',
    property: 'Tech Plaza',
    zone: 'EV Station 4',
    rule: 'EV not in use',
    confidence: 0.92,
    ...
    duration: '15m',
    cameraId: 'CAM-04',
    aiReasoning: 'Vehicle is parked in an EV charging spot but is not actively charging.'
  },
  {
    id: 'viol-3',
    vehicleId: 'v5',
    plate: 'GHI-7788',
    vehicleImage: 'https://picsum.photos/seed/trash/400/300',
    property: 'Skyline Apartments',
    zone: 'Trash Enclosure',
    rule: 'Trash overflow',
    confidence: 0.88,
    ...
    duration: 'N/A',
    cameraId: 'CAM-02',
    aiReasoning: 'AI detected debris exceeding the capacity of the disposal unit, creating a sanitation hazard.'
  },
  {
    id: 'viol-4',
    vehicleId: 'v6',
    plate: 'DEF-4433',
    vehicleImage: 'https://picsum.photos/seed/hazard/400/300',
    property: 'Skyline Apartments',
    zone: 'Main Lobby Entrance',
    rule: 'Slip n fall risk',
    confidence: 0.95,
    ...
    duration: '2m',
    cameraId: 'CAM-01',
    aiReasoning: 'Liquid spill detected in high-traffic pedestrian walkway without caution signage.'
  },
  {
    id: 'viol-5',
    vehicleId: 'v7',
    ...
    duration: '8h',
    cameraId: 'CAM-03',
    aiReasoning: 'Vehicle remained in visitor parking past the 2:00 AM security cutoff.',
    reviewerId: 'u2',
    decisionTimestamp: '2026-04-09T07:30:00Z',
    rejectionReason: 'Authorized vehicle - security manual override permit found.'
  }
];
